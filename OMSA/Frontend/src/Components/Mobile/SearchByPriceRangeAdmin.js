...
function SearchByPriceRangeAdmin() {
  const { minp, maxp } = useParams();
  ...
  const getMobileByPrice = async (e) => {
    const mobileInfo = await MobileService.getByPriceRange(minp, maxp);
  ...
  return (
    <div className='mystyle'>
      ...
      <h3 style={{ color: "white", fontFamily: "cursive" }}>Mobiles ranging from ₹{minp}-₹{maxp}:</h3>
...
export default SearchByPriceRangeAdmin;