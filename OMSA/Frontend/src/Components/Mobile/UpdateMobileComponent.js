...
function UpdateMobileComponent() {
  const { id } = useParams();
  ...
  const addDataToServer = (data) => {
    MobileService.updateMobile(data, id).then(
      (response) => {
    ...
    <div className="mystyle">
      ...
      <div className="container">
        <div className="w-75 mx-auto shadow p-5 mt-2 bg-light">
          <div class="jumbotron">
            <h3 class="display-4 text-center" style={{ paddingBottom: "10px", paddingTop: "10px", fontFamily: "cursive" }}>Update Mobile</h3>
            <div>
              <form onSubmit={(e) => FormHandle(e)}>
                ...
                <div class="form-group">
                  ...
                  <select className="form-select" style={{ boxShadow: "0px 2px 4px lightblue" }} onChange={(e) => onDropdownChange(e)}>
